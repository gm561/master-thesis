...
we have $\cB_0 \subseteq \cB_1$. Hence, multiplying (\ref{eq:diff_s01}) by $\Pr$:
\begin{align}
...
From (\ref{eq:diff_s01_next}) for $\pi_1 = \pi^*$ fixed we obtain
\begin{align}
...
If $\underset{\pi^{k}}{\Pr}[g(1, c_2, \dots, c_k) = 1 \land g(0, c_2, \dots,c_k ) = 0 \mid \pi_1 = \pi^*] \leq \frac{\epsilon}{6k}$ then
\begin{align}
