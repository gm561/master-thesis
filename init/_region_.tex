...
%
A \textit{canonical success} with respect to set $P_{hash}$ is a situation when a first successfully verification query is in $P_{hash}$,
...
\message{ !name(master.tex) !offset(-65) }
