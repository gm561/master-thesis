...
partition the set $\cQ$ into a set $\cQ_{adv}$ of advice queries and a set $\cQ_{attack}$ of attacking queries.
...
In this section we give a proof of Lemma~\ref{lemma:hash_function_probability}.
%
%
...
We~are interested in the probability over the choice of $\hash$ of the event $\CanonicalSuccess^{P,C,\hash}(\pi^*, \rho^*) = 1$
