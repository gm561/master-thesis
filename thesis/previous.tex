...
\subsection{The definition}
\begin{definition}[Dynamic Weakly Verifiable Puzzle, \cite{DBLP:journals/corr/abs-1002-3534}]
...
More formally, the following lemma is proved in \cite{Dodis:2009:SAI:1530441.1530450}.
\begin{lemma}
...
Detail calculations provided in \cite{Dodis:2009:SAI:1530441.1530450} show that this approach
...
\begin{definition}\textbf{($\boldsymbol{k}$-wise direct product of interactive weakly verifiable puzzles, \cite{DBLP:journals/corr/abs-1002-3534})}
