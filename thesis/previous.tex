...
The focus of this chapter is on the previous research concerning different types of weakly verifiable puzzles
that have been studied in a series of works \cite{canetti2004hardness, Dodis:2009:SAI:1530441.1530450, DBLP:journals/corr/abs-1002-3534}.
We give a short overview of the techniques used in these papers and aim to provide some intuition and insight into
the problem of the hardness amplification for dynamic interactive weakly verifiable puzzles.
First, we introduce the notion of a \textit{weakly verifiable puzzles} which are non-interactive and non-dynamic puzzles studied in
\cite{canetti2004hardness}. Then, in Section \ref{section:dijk} we bring our focus on dynamic non-interactive puzzles studies in \cite{Dodis:2009:SAI:1530441.1530450}.
...
\label{subsec:chs}
he notion of the \textit{weakly verifiable puzzles} has been coined by Canetti, Halevi, and Steiner in the paper
...
Moreover, the number of verification queries is limited to one. This constitutes a special case to of Definition \ref{def:dwvp}.
...
%
\subsection{Definition of weakly verifiable puzzles}
...
\subsection{Hardness amplification for weakly verifiable puzzles}
...
\subsection{Definition of interactive weakly verifiable puzzles}
...
\subsection{Hardness amplification for interactive weakly verifiable puzzles}
