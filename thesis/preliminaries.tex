...
On the other hand, in some situations we are interested in giving a more rigorous bounds on running time of algorithms
that take into account time need for oracle access. In these situations we compute running time of an algorithm
explicitly with regard to time needed for accessing oracle.
