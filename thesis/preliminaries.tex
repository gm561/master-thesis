...
The length of $x$ in the case of circuits is naturally bounded by the size of a circuit
...
For example, a protocol runs in the polynomial time if the size of $A_n$ and $B_n$ are bounded by some $\p(n)$.
