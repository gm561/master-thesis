...
The protocol execution between probabilistic circuits $A$ and $B$ is denoted by $\langle A, B \rangle$.
...
%\textbf{Polynomial time samplable.} The function $\mathit{hash} \in \cH$ is samplable in time $\poly(\lceil \log|\cD| \rceil, \lceil \log|\cR| \rceil)$.
