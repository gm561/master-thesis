...
Intuitively, it states that it is possible to amplify hardness where the circuit $\widetilde{C}$, meeting certain criteria, is used.
...
that yields a circuit $\widetilde{D} := (D_1, \widetilde{D}_2)$ and almost surely over the randomness of $\widetilde{\Gen}$ satisfies
\begin{align}
