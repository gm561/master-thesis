...
\end{align*}
We now show the circuit $\widetilde{C}$ succeeds with probability at least as high as $C$ in the experiment $\CanonicalSuccess$.
%
\begin{lemma}
...
Intuitively, it states that it is possible to amplify hardness in case the circuit $\widetilde{C}$ is used.
