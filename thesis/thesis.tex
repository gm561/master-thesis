...
In the previous chapter we defined a very general notion of dynamic interactive weakly verifiable puzzles.
The focus of this chapter is on giving a constructive proof of hardness amplification for this type of puzzles.
...
Next, we give a proof of security amplification under the assumption that the domain is well partitioned.
Finally, in Section \ref{st:put_together} we combine these both steps which yields the desirable result.
%
