...
that are weakly verifiable. The Section \ref{st:previous_results} is devoted to the previous research concerning different types of weakly verifiable puzzles.
%
\input{def_diwvp}
\input{examples}
\input{previous}
