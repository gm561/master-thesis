...
We start by formulating the definition of dynamic interactive weakly verifiable puzzles in Section \ref{section:wvp}.
To familiarize the Reader with this notion and provide more intuition, in Section \ref{section:wvp_examples} we describe
