...
\subsection{Hardness implication statements}
\subsection{Computational security}
\subsection{Information--theoretic security}
\section{Weakly verifiable puzzles}
\subsection{Interactive weakly verifiable puzzles}
\subsection{Dynamic weakly verifiable puzzles}
\section{Proof Interactive Dynamic puzzles}
\input{interactive_proof/definitions}
