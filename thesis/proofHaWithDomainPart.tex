...
In this section we prove Lemma \ref{lemma:sec_amp_for_p_hash}. The proof in the great extent bases on \cite{holenstein2011general}.

We show now that for a fixed $P$ and $hash$ the circuit $\widetilde{C}$ succeeds with probability at least as high as
$C$ in the experiment $\CanonicalSuccess$
%
\begin{lemma}
