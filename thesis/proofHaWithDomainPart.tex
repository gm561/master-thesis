...
Hence, we suspect that a puzzle on the first position is correctly solved unusually often.
...
The proof requires lengthly probability manipulations. In Appendix \ref{st:proofSimAssm} we give a shorter proof
...
\end{align}
Clearly, the running time of $\widetilde{\Gen} = \poly(k, \frac{1}{\epsilon}, n)$ with oracle access.
